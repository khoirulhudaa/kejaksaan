                    ...
                    @foreach ( $data as $item )
                        <tbody>
                            <tr height="40px">
                                ...
                                <td style="text-align: center;">{{ $item->pimpinan }}</td>
                                <td style="text-align: justify;word-break: break-all">{{ $item->alamat }}</td>
                                <td style="text-align: center;">{{ $item->kegiatan }}</td>
                                <td style="text-align: center;">{{ $item->jumlah_pengikut }}</td>
                                <td style="text-align: center;">{{ $item->nomor_pendaftaran }} / {{ $item->tgl_pendaftaran }} </td>
                                <td style="text-align: center;">{{ $item->nomor_badan }} / {{ $item->tgl_badan }} </td>
